...
import InvestorPage from './entrepreneurs/page';
        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:block">
            <ul className="flex">
              ...
              <li className="ml-8"><a href="/src/app/financial-learning/page.tsx" className="font-medium hover:text-pink-500 transition-colors">Finance</a></li>
              ...
              <li className="ml-8"><a href="/src/app/entrepreneurs/page.t" className="font-medium hover:text-pink-500 transition-colors">InvestorPage</a></li>
              <li className="ml-8"><a href="#" className="font-medium hover:text-pink-500 transition-colors">profile</a></li>
            </ul>
          </nav>
          <div className="flex items-center">
            <a href="/src/app/auth/sign-in/page.tsx" className="mr-4 font-medium">Login</a>
            <a href="/src/app/auth/sign-up/page.tsx" className="bg-pink-500 text-white px-5 py-2 rounded-full font-medium hover:bg-pink-600 transition-colors">Sign Up</a>
          </div>
        </div>
      </header>
